						...
						<div   style="background: #fff; cursor: pointer; border: 0px solid #ccc;padding: 5px 10px;align-right: 10px;line-height:16px;">		
							<form class="form-inline" role="form" onsubmit="return false;" id="form_${tableId}">	
								<div class="widget-buttons">	
                                       <div id="reservation_pub"  style="background: #fff; cursor: pointer; border: 1px solid #ccc;padding: 5px 10px;line-height:16px;">
			                   	...
			                   	<input id="-id-datetime_pub" type="hidden" name="datetime_stat_date" value="${statDate} 至   ${statDate}" />
...
$(document).ready(function() {
	//look-up 查询条件 会员 
	 	...
	 	var cb = function(start, end, label) {
	        $('#reservation_pub span').html(start.format('YYYY-MM-DD') + ' 至 ' + end.format('YYYY-MM-DD'));
	        $('#-id-datetime_pub').val(start.format('YYYY-MM-DD') + ' 至 ' + end.format('YYYY-MM-DD'));
	       // loadChartData();
	      };
...
//	         minDate: '',
	      ...
	      $('#reservation_pub').daterangepicker(optionSet1,cb); 
 ...
 TableAjax.init('${tableId}',{
	 ...
	 aoColumns: [
			...
			{sTitle:'媒体收入',  mData: "income",uxNumber:true},			//数字靠右显示	
			{sTitle:'平台服务费',  mData: "last_income",uxLongText:true},						
			{sTitle:'服务费率',  mData: "incomestr",uxLongText:true}		        
