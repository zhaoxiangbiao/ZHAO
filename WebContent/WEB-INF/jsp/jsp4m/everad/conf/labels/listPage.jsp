...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/everad/conf/labels/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_EVERAD_CONF_LABELS_" ></c:set>
<c:set scope="page" var="dataTitle" value="标签库" ></c:set>
<c:set scope="page" var="tableId" value="data_table_everad_conf_labels_1" ></c:set>
<div class="row">
				<div class="col-md-12">
			...
			<div class="widget-header ">
                ...
                <%--   <div class="widget-buttons buttons-bordered">
						...
						<form class="form-inline" role="form" onsubmit="return false;" id="form_${tableId}">
								...
								<label  class="col-sm-4 control-label no-padding-right">标签名</label>
								<div class="col-sm-8">
...
$(document).ready(function() {
 ...
 TableAjax.init('${tableId}',{
	 ...
	 uxDrapable:false,
	 aoColumns: [		
			{sTitle:'标签名',  mData: "label",uxLongText:true},				
			{sTitle:'标签下对应的人数',  mData: "user_count",uxLongText:true},		        
          {uxCogs:[
	          {name:"查看"}
