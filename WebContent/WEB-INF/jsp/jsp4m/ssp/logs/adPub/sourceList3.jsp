...
<div class="row">
	...
	<div class="data-div">
				...
				<div class="widget collapsed " style="margin-top:5px;margin-bottom:0px">
					...
					<input type="hidden" id="startDateSS3" name="startDate" value="" >
					<input type="hidden" id="endDateSS3" name="endDate" value="" >
<!-- 						 <div class=""> -->
...
$(document).ready(function() {
 	...
 	var cb = function(start, end, label) {
        $('#reservation-SS3 span').html(start.format('YYYY-MM-DD') + ' 至 ' + end.format('YYYY-MM-DD'));
        $('#startDateSS3').val(start.format('YYYY-MM-DD'));
        $('#endDateSS3').val(end.format('YYYY-MM-DD'));
        dailyTable.fnDraw();
      };
...
//         maxDate: '12/31/2015',
      ...
      $('#reservation-SS3').daterangepicker(optionSet1,cb);  
      $('#reservation-SS3 span').html(moment().subtract(0, 'days').format('YYYY-MM-DD') + ' 至 ' + moment().format('YYYY-MM-DD'));
      $('#startDateSS3').val(moment().subtract(0, 'days').format('YYYY-MM-DD'));
      $('#endDateSS3').val(moment().format('YYYY-MM-DD'));
