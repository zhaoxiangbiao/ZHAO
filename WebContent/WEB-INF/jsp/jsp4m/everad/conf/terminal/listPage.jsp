...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/everad/conf/terminal/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_EVERAD_CONF_TERMINAL_" ></c:set>
<c:set scope="page" var="dataTitle" value="智能终端库" ></c:set>
<c:set scope="page" var="tableId" value="data_table_everad_conf_terminal_1" ></c:set>
<div class="row">
				<div class="col-md-12">
	...
	<!-- 
								...
								<div class="col-sm-8">
									<input type="text" class="form-control  " name="filter_LIKES_terninal_name"  placeholder="">
								</div>
								</div>
...
$(document).ready(function() {
 ...
 TableAjax.init('${tableId}',{
	 ...
	 uxDrapable:false,
	 aoColumns: [		
			{sTitle:'账号码',  mData: "phone_number",uxLongText:true},				
