...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/everad/conf/terminalUa/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_EVERAD_CONF_TERMINALUA_" ></c:set>
<c:set scope="page" var="dataTitle" value="智能终端特征库" ></c:set>
<c:set scope="page" var="tableId" value="data_table_everad_conf_terminalUa_1" ></c:set>
<div class="row">
				<div class="col-md-12">
				...
				<span class="widget-caption">数据列表</span>
                  ...
                  <div class="widget-buttons buttons-bordered">
						...
						<form class="form-inline" role="form" onsubmit="return false;" id="form_${tableId}">
								...
								<label  class="col-sm-4 control-label no-padding-right">智能终端名称</label>
								<div class="col-sm-8">
									<input type="text" class="form-control  " name="filter_LIKES_terminal_name"  placeholder="">
								</div>
								</div>
							
	
								<div class="form-group ">
								<label  class="col-sm-4 control-label no-padding-right">ua特征</label>
								<div class="col-sm-8">
...
$(document).ready(function() {
 ...
 TableAjax.init('${tableId}',{
	 ...
	 uxDrapable:false,
	 aoColumns: [		
			{sTitle:'智能终端名称',  mData: "terminal_name",uxLongText:true},				
			{sTitle:'ua特征',  mData: "ua_reg",uxLongText:true},		        
          {uxCogs:[
	          {name:"查看"}
