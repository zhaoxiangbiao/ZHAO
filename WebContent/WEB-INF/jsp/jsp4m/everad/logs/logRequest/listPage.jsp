...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/everad/logs/logRequest/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_EVERAD_LOGS_LOGREQUEST_" ></c:set>
<c:set scope="page" var="dataTitle" value="推送日志表" ></c:set>
<c:set scope="page" var="tableId" value="data_table_everad_logs_logRequest_1" ></c:set>
                  ...
                  <div class="widget-buttons">
						...
						<div class="widget-body">
							...
							<input id="action_time" class="form-control date-range-picker " name="action_time"  type="hidden" value="${today }" />
								...
								<div class="col-sm-8">
									<input type="text" class="form-control  " name="filter_LIKES_ct"  placeholder="">
								</div>
								</div>
...
$(document).ready(function() {
 ...
 TableAjax.init('${tableId}',{
	 ...
	 aoColumns: [		
			...
			{sTitle:'平台类型',mData: "ct" ,uxEnum:'ea_target_platform'},			
