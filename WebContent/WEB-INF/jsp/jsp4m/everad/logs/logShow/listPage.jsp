...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/everad/logs/logShow/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_EVERAD_LOGS_LOGSHOW_" ></c:set>
<c:set scope="page" var="dataTitle" value="展示日志表" ></c:set>
<c:set scope="page" var="tableId" value="data_table_everad_logs_logShow_1" ></c:set>
<div class="row">
				<div class="col-md-12">
