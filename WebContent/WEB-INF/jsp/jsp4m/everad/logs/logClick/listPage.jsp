...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/everad/logs/logClick/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_EVERAD_LOGS_LOGCLICK_" ></c:set>
<c:set scope="page" var="dataTitle" value="点击日志表" ></c:set>
<c:set scope="page" var="tableId" value="data_table_everad_logs_logClick_1" ></c:set>
<div class="row">
				<div class="col-md-12">
