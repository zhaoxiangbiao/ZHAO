...
<c:set scope="page" var="tableId" value="data_table_ssp_logs_sourceIncome_2" ></c:set>
						...
						<div class="widget-header ">
							...
							<form class="form-inline" role="form" onsubmit="return false;" id="form_${tableId}">
								<input type="hidden" id="startDateSS1" name="statDate" value="${statDate }" >
										...
										三方API名称: <input type="text"  style="height:26px;margin-top:-1px;" class="form-control  " name="sName"  placeholder="">
...
//		  	  return '<a class="blue-stripes" href="javascript:loadChartData('+data+',\''+all.${tt}_name+'\');" ">查看数据</a> ';	        
     ...
     var oTable = TableAjax.init('${tableId}',{
					 sAjaxSource: "${urlPrev }sourceIncomeJson2",
					 ...
					 aoColumns: [		
									{sTitle:'三方API',"sWidth": "140px",mData: "odsp_name" },
...
//              	 id:aData['id'],
                	 ...
                	 cli:aData['cli'],
                	 target_type:2,
                	 target_id:aData['odsp_id'],
                	 target_name:aData['odsp_name'],
                	 stat_date:'${statDate }',
                	 income:income
              },
