...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/everad/conf/appBlacklist/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_EVERAD_CONF_APPBLACKLIST_" ></c:set>
<c:set scope="page" var="dataTitle" value="APP黑名单表" ></c:set>
<c:set scope="page" var="tableId" value="data_table_everad_conf_appBlacklist_1" ></c:set>
<div class="row">
				<div class="col-md-12">
				...
				<span class="widget-caption">数据列表</span>
                  ...
                  <div class="widget-buttons buttons-bordered">
						...
						<form class="form-inline" role="form" onsubmit="return false;" id="form_${tableId}">
								...
								<label  class="col-sm-4 control-label no-padding-right">app</label>
								<div class="col-sm-8">
...
$(document).ready(function() {
 ...
 TableAjax.init('${tableId}',{
	 ...
	 uxDrapable:false,
	 aoColumns: [		
			{sTitle:'app',  mData: "name",uxLongText:true},		        
          {uxCogs:[
	          {name:"查看"}
