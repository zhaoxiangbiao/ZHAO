...
//         maxDate: '12/31/2015',
      ...
      dailyTable = TableAjax.init('${tableId}4',{
					 sAjaxSource: "${urlPrev }dailyJsonIncome",
...
// 									{sTitle:'${ttName}名称',  mData: "${tt}_name",bSortable:true,uxCutText:10,sWidth:"150px"},				
									...
									{sTitle:'毛收入',mData: "gross_income" ,uxPrice:true},
									{sTitle:'净收入',mData: "net_income" ,uxPrice:true},
									{sTitle:'最终收入',mData: "final_income" ,uxPrice:true},
									{sTitle:'服务费',mData: "service_charge" ,uxPrice:true}
