...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/everad/conf/conf/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_EVERAD_CONF_CONF_" ></c:set>
<c:set scope="page" var="dataTitle" value="全局配置表" ></c:set>
<c:set scope="page" var="tableId" value="data_table_everad_conf_conf_1" ></c:set>
<div class="row">
				<div class="col-md-12">
				...
				<span class="widget-caption">数据列表</span>
                  ...
                  <div class="widget-buttons buttons-bordered">
						...
						<form class="form-inline" role="form" onsubmit="return false;" id="form_${tableId}">
								...
								<label  class="col-sm-4 control-label no-padding-right">配置项key</label>
								<div class="col-sm-8">
									<input type="text" class="form-control  " name="filter_LIKES_conf_key"  placeholder="">
								</div>
								</div>
							
	
								<div class="form-group ">
								<label  class="col-sm-4 control-label no-padding-right">配置项名称name</label>
								<div class="col-sm-8">
								...
								<div class="form-group ">
								<label  class="col-sm-4 control-label no-padding-right">配置项值</label>
								<div class="col-sm-8">
									<input type="text" class="form-control  " name="filter_LIKES_conf_value"  placeholder="">
								</div>
								</div>
...
$(document).ready(function() {
 ...
 TableAjax.init('${tableId}',{
	 ...
	 uxDrapable:false,
	 aoColumns: [		
			{sTitle:'配置项key',  mData: "conf_key",uxLongText:true},				
			{sTitle:'配置项名称name',  mData: "name",uxLongText:true},				
			{sTitle:'配置项值',  mData: "conf_value",uxLongText:true},		        
          {uxCogs:[
	          {name:"查看"}
