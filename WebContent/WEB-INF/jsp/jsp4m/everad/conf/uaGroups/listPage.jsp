...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/everad/conf/uaGroups/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_EVERAD_CONF_UAGROUPS_" ></c:set>
<c:set scope="page" var="dataTitle" value="UA白名单组" ></c:set>
<c:set scope="page" var="tableId" value="data_table_everad_conf_uaGroups_1" ></c:set>
<div class="row">
				<div class="col-md-12">
				...
				<span class="widget-caption">数据列表</span>
                  ...
                  <div class="widget-buttons buttons-bordered">
						...
						<form class="form-inline" role="form" onsubmit="return false;" id="form_${tableId}">
								...
								<label  class="col-sm-4 control-label no-padding-right">UA的组名称</label>
								<div class="col-sm-8">
								...
								<div class="form-group ">
								<label  class="col-sm-4 control-label no-padding-right">项目列表（UA明细）</label>
								<div class="col-sm-8">
...
$(document).ready(function() {
 ...
 TableAjax.init('${tableId}',{
	 ...
	 uxDrapable:false,
	 aoColumns: [		
			{sTitle:'UA的组名称',  mData: "name",uxLongText:true},				
			{sTitle:'项目列表（UA明细）',  mData: "items",uxLongText:true},		        
          {uxCogs:[
	          {name:"查看"}
