...
<style>
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <form id="${formId }" method="post" action="${ctx}/ssp/config/adSlot/save" class="bv-form ad-create-form  col-lg-8 col-sm-12 col-xs-12" >
           	<div class="form-body">
            ...
            <div class="clearfix">
                <div class="widget ">
                    ...
                    <div class="widget-body clearfix" style="position:relative">
                        <div class="form-horizontal" style="position:relative">
                            <div class="clearfix">
                                ...
                                <div class="form-group col-sm-6">
                                   <label for="s2id_autogen9" class="col-sm-3 control-label no-padding-right">站点</label>
                                   	<div class="col-sm-6">
                                    <input data-bv-notempty="true" class="select2" style="width:100%" name="site_id.site_id" type="select" value="${adSlot.site_id.site_id}" display-value="${adSlot.site_id.site_name}"  result-field="site_name" value-field="site_id" lookup-url="${ctx}/ssp/config/adSite/listJSON" filter="filter_LIKES_site_id"/>
                                	</div>
                                </div>
                            </div>
                            ...
                            <div class="clearfix">
                                ...
                                <div class="form-group col-sm-6">
                                   <label for="" class="col-sm-3 control-label no-padding-right">平台</label>
                                   	<div class="col-sm-6">
                                   	<!-- 
                                   		<select id="platform-selected" name="">
                                   			<option selected value="3">PC端+移动端</option>
							...
							<div style="position: absolute;left: 0;top: 0;background: transparent;width: 100%;height: 100%;z-index: 99999;"></div>
                        </div>
                                                        ...
                                                        <div id="mobile-ad-float" class="tab-pane active clearfix ">
                                                            ...
                                                            <div class="tabbable clearfix">
                                                                <div class="tab-content" >
																	...
																	尺寸：<div class="form-inline form-group">
                                    ...
                                    <div class="widget">
                                        ...
                                        <div class="widget-body">
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div class="form-inline col-xs-10 ">
                                            			...
                                            			<input class="form-control input-50" type="text" name="times_per_union_mobile" value="${adTactics.times_per_union_mobile}" data-bv-regexp="true" data-bv-regexp-regexp="[0-9]+" data-bv-regexp-message="请输入数字！"/>次
                                        				</div>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-10 form-inline ">
                                                    <textarea id="url_whitelist_mobile" class="form-control" name="url_whitelist_mobile" data-bv-notempty="true" data-bv-notempty-message="此处不能为空！">${adTactics.url_whitelist_mobile}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="widget-body">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                <label for="id-date-picker-1" class="col-sm-2 control-label no-padding-right">广告排期</label>
                                                <div class="col-xs-10 form-inline ">
                                                    <input id="dpd1" placeholder='' class="form-control date-picker " name="ad_start_time_pc" type="text" readonly="true" value="<fmt:formatDate value="${adTactics.ad_start_time_pc}" pattern="yyyy-MM-dd" />" />
                                                    &nbsp;至&nbsp;
                                                    <input id="dpd2" placeholder='' class="form-control date-picker " name="ad_end_time_pc"  type="text"  readonly="true" value="<fmt:formatDate value="${adTactics.ad_end_time_pc}" pattern="yyyy-MM-dd" />" />
                                                </div>
                                            </div>
                                        ...
                                        <tag:enum id="select-uvtime-pc" cssClass="form-control-inline input-medium select2me" name="publish_scheme_per_uv_pc" attrs=""  enumName="t_publish_scheme" inputType="select" enumKey="${adTactics.publish_scheme_per_uv_pc}"/>
                                            ...
                                            <input class="form-control input-50" type="text" name="times_per_union_pc" value="${adTactics.times_per_union_pc}" data-bv-regexp="true" data-bv-regexp-regexp="[0-9]+" data-bv-regexp-message="请输入数字！"/>次
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="id-date-picker-1" class="col-sm-2 control-label no-padding-right">URL白名单</label>
                                            <div class="col-xs-10 form-inline ">
                                                <textarea id="url_whitelist_pc" class="form-control" name="url_whitelist_pc" data-bv-notempty="true" data-bv-notempty-message="此处不能为空！">${adTactics.url_whitelist_pc}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="col-lg-2 col-sm-12 col-xs-12" style="margin-left:-40px;">
...
/* 	//右下角 ad-right-classif
    ...
    <script>
       ...
       //定义一个全局变量，开关，以实现不同平台之间切换时对应数据是否清空
       var flag = false;
       $(function(){
    	   //根据不同的平台显示不同的tab页
  	   	   var selfname = ['','pc-end','mobile-end','pc-end'];
            ...
            $("#slot_target_floor").change(function(){
            	...
            	if(val==1){
            		...
            		$("#slot_type_pc").val(0);
               		...
               		$("#select-uvrate-pc").attr("defaultValue",1);
            		...
            		$("#slot_type_mobile").val(0);
               		...
               		$("#select-uvrate-mobile").attr("defaultValue",1);
            	}else{
            		$("#"+selfname[val]).addClass("active");
            		$("#slot_type_pc").val(0);
               		$("#slot_shape_float_pc").val(1);
