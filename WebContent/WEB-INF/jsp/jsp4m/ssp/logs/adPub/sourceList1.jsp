...
<!-- 								<label class="control-label">终端类型：</label>  -->
                                       ...
                                       <div class="radio">
										...
										<div class="widget-buttons" >	
				                                 <div id="reservation-SS1"  style="background: #fff; cursor: pointer; border: 1px solid #ccc;padding: 5px 10px;line-height:16px;">
...
$(document).ready(function() {
 	...
 	var cb = function(start, end, label) {
        $('#reservation-SS1 span').html(start.format('YYYY-MM-DD') + ' 至 ' + end.format('YYYY-MM-DD'));
...
//         maxDate: '12/31/2015',
      ...
      $('#reservation-SS1').daterangepicker(optionSet1,cb);  
      $('#reservation-SS1 span').html(moment().subtract(0, 'days').format('YYYY-MM-DD') + ' 至 ' + moment().format('YYYY-MM-DD'));
      ...
      dailyTable = TableAjax.init('${tableId}4',{
					 ...
					 aoColumns: [		
									{sTitle:'三方源ID',mData: "source_id" },
									{sTitle:'三方源',mData: "source_name" },
									{sTitle:'原始广告位ID',mData: "source_slot_id" },
									{sTitle:'原始广告位',mData: "source_slot_name" },
