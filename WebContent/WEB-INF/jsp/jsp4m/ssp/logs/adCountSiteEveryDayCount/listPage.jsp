...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/ssp/logs/adCountSiteEveryDayCount/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_SSP_LOGS_ADCOUNTSITEEVERYDAYCOUNT_" ></c:set>
<c:set scope="page" var="dataTitle" value="站点每日明细" ></c:set>
<c:set scope="page" var="tableId" value="data_table_ssp_logs_adCountSiteEveryDayCount_1" ></c:set>
<%
...
//	         minDate: '',
 ...
 TableAjax.init('${tableId}',{
	 sAjaxSource: "${urlPrev }listJSON?siteid=${siteid}",
	 ...
	 aoColumns: [
			...
			{sTitle:'站点名称',  mData: "sitename",uxLongText:true},				
