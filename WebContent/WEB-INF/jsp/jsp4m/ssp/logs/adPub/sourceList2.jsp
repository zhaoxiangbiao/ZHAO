...
<c:set scope="page" var="tableId" value="data_table_ssp_logs_adPub_SS2" ></c:set>
<%
...
<div class="row">
	...
	<div class="data-div">
				...
				<div class="widget collapsed " style="margin-top:5px;margin-bottom:0px">
					...
					<input type="hidden" id="clientTypeSS2" name=clientType value="0" >
					<input type="hidden"  name="tableType" value="${tt}" >
					<input type="hidden" id="startDateSS2" name="startDate" value="" >
					<input type="hidden" id="endDateSS2" name="endDate" value="" >
<!-- 						 <div class=""> -->
<!-- 								<label class="control-label">终端类型：</label> -->
<!--                                        <div class="radio"> -->
<!--                                            <label> -->
<!--                                                <input name="clientTypeSS2"  type="radio" checked="checked"  onclick="javascript:loadSS2(this);" value="0" > -->
<!--                                                <span class="text">全部 </span> -->
<!--                                            </label> -->
<!--                                        </div> -->
<!--                                        <div class="radio"> -->
<!--                                            <label> -->
<!--                                                <input name="clientTypeSS2"   type="radio" value="1"   onclick="javascript:loadSS2(this);" > -->
<!--                                                <span class="text">PC </span> -->
<!--                                            </label> -->
<!--                                        </div> -->
<!--                                        <div class="radio"> -->
<!--                                              <label> -->
<!--                                                  <input name="clientTypeSS2"   type="radio" value="2"  onclick="javascript:loadSS2(this);" > -->
...
<!-- 						</div>                                   -->
										...
										<div class="widget-buttons" >	
				                                 <div id="reservation-SS2"  style="background: #fff; cursor: pointer; border: 1px solid #ccc;padding: 5px 10px;line-height:16px;">
...
var dailyTable;
function loadSS2(t){
	$('#clientTypeSS2').val(t.value);
	dailyTable.fnDraw();
}
$(document).ready(function() {
	
 	var cb = function(start, end, label) {
        $('#reservation-SS2 span').html(start.format('YYYY-MM-DD') + ' 至 ' + end.format('YYYY-MM-DD'));
        $('#startDateSS2').val(start.format('YYYY-MM-DD'));
        $('#endDateSS2').val(end.format('YYYY-MM-DD'));
        dailyTable.fnDraw();
      };
...
//         maxDate: '12/31/2015',
      ...
      $('#reservation-SS2').daterangepicker(optionSet1,cb);  
      $('#reservation-SS2 span').html(moment().subtract(0, 'days').format('YYYY-MM-DD') + ' 至 ' + moment().format('YYYY-MM-DD'));
      $('#startDateSS2').val(moment().subtract(0, 'days').format('YYYY-MM-DD'));
      $('#endDateSS2').val(moment().format('YYYY-MM-DD'));
 	
      dailyTable = TableAjax.init('${tableId}4',{
					 sAjaxSource: "${urlPrev }ss2Json",
					 ...
					 aoColumns: [		
									{sTitle:'三方DSP-ID',mData: "odsp_id" },
									{sTitle:'三方DSP',mData: "odsp_name" },
