...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/everad/conf/blackUserSeg/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_EVERAD_CONF_BLACKUSERSEG_" ></c:set>
<c:set scope="page" var="dataTitle" value="全局号码段黑名单" ></c:set>
<c:set scope="page" var="tableId" value="data_table_everad_conf_blackUserSeg_1" ></c:set>
<div class="row">
				<div class="col-md-12">
...
$(document).ready(function() {
 ...
 TableAjax.init('${tableId}',{
	 ...
	 aoColumns: [		
			...
			//{sTitle:'是够生效',  mData: "is_effect",uxLongText:true},		        
          {uxCogs:[
	          {name:"查看"}
