...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/everad/conf/blackUser/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_EVERAD_CONF_BLACKUSER_" ></c:set>
<c:set scope="page" var="dataTitle" value="全局黑名单" ></c:set>
<c:set scope="page" var="tableId" value="data_table_everad_conf_blackUser_1" ></c:set>
<div class="row">
				<div class="col-md-12">
				...
				<span class="widget-caption">数据列表</span>
                  ...
                  <div class="widget-buttons buttons-bordered">
						...
						<form class="form-inline" role="form" onsubmit="return false;" id="form_${tableId}">
								...
								<label  class="col-sm-4 control-label no-padding-right">黑名单号码</label>
								<div class="col-sm-8">
								...
								<%-- <div class="form-group ">
								<label  class="col-sm-4 control-label no-padding-right">是够生效</label>
								<div class="col-sm-8">
									<tag:enum name="filter_EQI_is_effect"  attrs="placeholder=''" cssClass="form-control  select2me"  enumName="isOrNot" tagType="edit" />
...
$(document).ready(function() {
 ...
 TableAjax.init('${tableId}',{
	 ...
	 uxDrapable:false,
	 aoColumns: [		
			{sTitle:'黑名单号码',  mData: "phone_number",uxLongText:true},		
			//{sTitle:'是够生效',mData: "is_effect" ,uxEnum:'isOrNot'},        
          {uxCogs:[
	          {name:"查看"}
