...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/everad/conf/showControl/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_EVERAD_CONF_SHOWCONTROL_" ></c:set>
<c:set scope="page" var="dataTitle" value="显示控制表" ></c:set>
<c:set scope="page" var="tableId" value="data_table_everad_conf_showControl_1" ></c:set>
<div class="row">
				<div class="col-md-12">
				...
				<span class="widget-caption">数据列表</span>
                  ...
                  <div class="widget-buttons buttons-bordered">
						...
						<form class="form-inline" role="form" onsubmit="return false;" id="form_${tableId}">
								...
								<div class="form-group ">
								<label  class="col-sm-4 control-label no-padding-right">是否生效</label>
								<div class="col-sm-8">
									<tag:enum name="filter_EQI_is_active"  attrs="placeholder=''" cssClass="form-control  select2me"  enumName="isOrNot" tagType="edit" />
...
$(document).ready(function() {
 ...
 TableAjax.init('${tableId}',{
	 ...
	 aoColumns: [		
			...
			{sTitle:'是否生效',mData: "is_active" ,uxEnum:'isOrNot'},        
          {uxCogs:[
	          {name:"查看"}
