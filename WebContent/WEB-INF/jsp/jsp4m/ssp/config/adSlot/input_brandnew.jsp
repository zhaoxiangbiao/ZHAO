            ...
            <div class="clearfix">
                <div class="widget ">
                        ...
                        <div class="form-horizontal">
                            <div class="clearfix">
                                <div  class="form-group col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control " type="text" name="slot_name" value="" data-bv-notempty="true" data-bv-notempty-message="此处不能为空！" ></div>
                                </div>
                                
                                <div class="form-group col-sm-6">
                                    <label for="" class="col-sm-3 control-label no-padding-right">平台</label>
                                    <div class="col-sm-6">
                                    <tag:enum id="slot_target_floor" cssClass="select2me" name="slot_target_floor" attrs="" cssStyle="width:100%" enumName="t_ad_target_type" inputType="select" defaultValue="3" enumKey="${adSlot.slot_target_floor}"/>
                                	</div>
                            	</div>
                            </div>
                        	...
                        	<div class="clearfix">
                                <div  class="form-group col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                      	<select id="pub_id" name="pubId" value="${adSlot.pub_id.pub_id}" style="width:100%">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                     	<select id="site_id" name="siteId" value="${adSlot.site_id.site_id}" style="width:100%">
                    ...
                    <div class="tabbable col-lg-12 col-sm-12 col-xs-12">
                            ...
                            <div class="pc-end tab-pane "  id="mobile-end">
                                ...
                                <div class="widget">
                                    ...
                                    <div class="widget-body">
                                        广告类型：
                                        <div class="inline-block">
                                            <tag:enum id="slot_style_mobile" cssClass="form-control form-control-inline input-medium select2me" name="slot_style_mobile" attrs=""  enumName="t_slot_style" inputType="radio" defaultValue="1" enumKey="${adSlot.slot_style_mobile}"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="widget">
                                    ...
                                    <div class="widget-body">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-10 form-inline ">
                                                    <input id="dpd1" placeholder='' class="form-control date-picker " name="ad_start_time_mobile" type="text" readonly="true" value="${adTactics.ad_start_time_mobile}" />
                                                    &nbsp;至&nbsp;
                                                    <input id="dpd2" placeholder='' class="form-control date-picker " name="ad_end_time_mobile"  type="text" readonly="true" value="${adTactics.ad_end_time_mobile}" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-10 form-inline ">
                                                    <input class="form-control " name="publish_everyday_mobile" type="text" value="500000" data-bv-notempty="true"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-inline col-xs-10 ">
                                                    <tag:enum id="select-uvrate-mobile" cssClass="form-control-inline input-medium select2me" name="publish_frequency_per_uv_mobile" attrs="" cssStyle="width:25%"  enumName="t_publish_frequecy" inputType="select" defaultValue="0" enumKey="${adTactics.publish_frequency_per_uv_mobile}"/>
                                                    <div class="inline-block" id="select-uvrate-detail-mobile" style="display:none;">
                                                        <tag:enum id="select-uvtime-mobile" cssClass="form-control-inline input-medium select2me" name="publish_scheme_per_uv_mobile" attrs=""  enumName="t_publish_scheme" inputType="select" defaultValue="1" enumKey="${adTactics.publish_scheme_per_uv_mobile}"/>
                                                        &nbsp;&nbsp;
                                                        <span id="select-uvtime-text-mobile">小时</span>
                                                        <input class="form-control input-50" id="times_mobile" type="text" name="times_per_union_mobile" value="10"  data-bv-regexp="true" data-bv-regexp-regexp="^[0-9]+$" data-bv-regexp-message="请输入数字！"/>
                                                        次
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-10 form-inline ">
                                                    <div class="spinbox spinbox-horizontal inline-block">
                                                        <input type="text" class="spinbox-input form-control"   name="slot_time_interval_mobile"  value="300" data-bv-notempty="true"
                                                               data-bv-notempty-message="此处不能为空！" data-bv-regexp="true" data-bv-regexp-regexp="^[0-9]+$" data-bv-regexp-message="请输入数字！"/>
                                            ...
                                            <div class="form-group" id="show_time_mobile">
                                                <label for="id-date-picker-1" class="col-sm-2 control-label no-padding-right">广告展示</label>
                                                <div class="col-xs-10 form-inline ">
                                                    <div class="spinbox spinbox-horizontal inline-block">
                                                        <input type="text" class="spinbox-input form-control"   name="slot_residencetime_mobile"  value="30" data-bv-notempty="true"
                                                               data-bv-notempty-message="此处不能为空！" data-bv-regexp="true" data-bv-regexp-regexp="^[0-9]+$" data-bv-regexp-message="请输入数字！">
                                                        <div class="spinbox-buttons btn-group">
                                                            <button type="button" class="btn spinbox-down blueberry">
                                                                <i class="fa fa-minus"></i>
                                            ...
                                            <div class="col-xs-10 form-inline ">
                                                <tag:enum cssClass="form-control-inline input-medium select2me" name="compensation_scheme_mobile" attrs="" cssStyle="width:25%" enumName="t_compensation_scheme" inputType="select" defaultValue="1" enumKey="${adTactics.compensation_scheme_mobile}"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-10 form-inline ">
                                                <textarea class="form-control" name="url_whitelist_mobile">${adTactics.url_whitelist_mobile}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                        ...
                        <!-- pc端 -->
                        <div class="pc-end tab-pane in active" id="pc-end">
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    广告类型：
                                    <div class="inline-block">
                                        <tag:enum id="slot_style_pc" cssClass="form-control form-control-inline input-medium select2me" name="slot_style_pc" attrs=""  enumName="t_slot_style" inputType="radio" defaultValue="1" enumKey="${adSlot.slot_style_pc}"/>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="widget-body">
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            <label for="id-date-picker-1" class="col-sm-2 control-label no-padding-right">广告排期</label>
                                            <div class="col-xs-10 form-inline ">
                                                <input id="dpd3" placeholder='' class="form-control date-picker " name="ad_start_time_pc"  type="text" readonly="true" value="${adTactics.ad_start_time_pc}"/>
                                                &nbsp;至&nbsp;
                                                <input id="dpd4" placeholder='' class="form-control date-picker " name="ad_end_time_pc"  type="text" readonly="true" value="${adTactics.ad_end_time_pc}"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="id-date-picker-1" class="col-sm-2 control-label no-padding-right">每日投放次数</label>
                                            <div class="col-xs-10 form-inline ">
                                                <input class="form-control " type="text" name="publish_everyday_pc" value="500000" data-bv-notempty="true"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="id-date-picker-1" class="col-sm-2 control-label no-padding-right">单UV投放频率</label>
                                            <div class="form-inline col-xs-10 ">
                                                <tag:enum id="select-uvrate-pc" cssClass="form-control-inline input-medium select2me" name="publish_frequency_per_uv_pc"  attrs="" cssStyle="width:25%" enumName="t_publish_frequecy"  inputType="select" defaultValue="0" enumKey="${adTactics.publish_frequency_per_uv_pc}"/>
                                                &nbsp;&nbsp;
                                                <div class="inline-block" id="select-uvrate-detail-pc" style="display:none;">
                                                    <tag:enum id="select-uvtime-pc" cssClass="form-control-inline input-medium select2me" name="publish_scheme_per_uv_pc" attrs=""  enumName="t_publish_scheme" inputType="select" defaultValue="1" enumKey="${adTactics.publish_scheme_per_uv_pc}"/>
                                                    &nbsp;&nbsp;
                                                    <span id="select-uvtime-text-pc">小时</span>
                                                    <input class="form-control input-50" id="times_pc" type="text" name="times_per_union_pc" value="10"  data-bv-regexp="true" data-bv-regexp-regexp="^[0-9]+$" data-bv-regexp-message="请输入数字！">次</div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-10 form-inline ">
                                                <div class="spinbox spinbox-horizontal inline-block">
                                                    <input type="text" class="spinbox-input form-control"   name="slot_time_interval_pc"  value="300" data-bv-notempty="true"
                                                               data-bv-notempty-message="此处不能为空！" data-bv-regexp="true" data-bv-regexp-regexp="^[0-9]+$" data-bv-regexp-message="请输入数字！">
                                        ...
                                        <div class="form-group" id="show_time_pc">
                                            <label for="id-date-picker-1" class="col-sm-2 control-label no-padding-right">广告展示</label>
                                            <div class="col-xs-10 form-inline ">
                                                <div class="spinbox spinbox-horizontal inline-block">
                                                    <input type="text" class="spinbox-input form-control"   name="slot_residencetime_pc"  value="30" data-bv-notempty="true"
                                                               data-bv-notempty-message="此处不能为空！" data-bv-regexp="true" data-bv-regexp-regexp="^[0-9]+$" data-bv-regexp-message="请输入数字！">
                                                    <div class="spinbox-buttons btn-group">
                                                        <button type="button" class="btn spinbox-down blueberry">
                                                            <i class="fa fa-minus"></i>
                                        ...
                                        <label for="id-date-picker-1" class="col-sm-2 control-label no-padding-right">若无合适广告投放，启用</label>
                                        <div class="col-xs-10 form-inline ">
                                            <tag:enum cssClass="form-control-inline input-medium select2me" name="compensation_scheme_pc" attrs="" cssStyle="width:25%" enumName="t_compensation_scheme" inputType="select" defaultValue="1" enumKey="${adTactics.compensation_scheme_pc}"/>
                                            <a href="javascript:void(0);" data-container="body" data-titleclass="bordered-blue" data-class="" data-toggle="popover" data-placement="right" data-title="名词解释" data-content="流量补余：当广告位在用户指定广告来源情况下，如果广告源没有广告返回，平台自动切换到其他广告源，如没有任何广告，则填充公益广告<br>
                                                流量返还：如果没有广告返回，则该次广告曝光不计入此次的流量使用。
                                                <br>
                                                默认开启流量返还。">
                                    ...
                                    <div class="form-group">
                                        <label for="id-date-picker-1" class="col-sm-2 control-label no-padding-right">URL白名单</label>
                                        <div class="col-xs-10 form-inline ">
                                            <textarea class="form-control" name="url_whitelist_pc">${adTactics.url_whitelist_pc}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
<script>
       ...
       $(function(){
           ...
           //根据pubList的第一个pub生成site的列表
           $.ajax({          
                url:"${ctx}/ssp/config/adSite/siteAjax?pubId="+${pubListFirst.pub_id},
                type : "get",    
                cache : false,    
                dataType : "json",   
         ...
         //移动端
           ...
           $('#myTab2 a').click(function (e) { 
            ...
            if(selectedHref=="#mobile-ad-float"){
                $("#show_time_mobile").show();
                $("#slot_type_mobile").val(0);
                $("#slot_shape_float_mobile").val(2);
                $("#slot_shape_fixed_mobile").val("");
            }else if(selectedHref=="#mobile-ad-fix"){
                $("#show_time_mobile").hide();
       ...
       //日期控件设置
        ...
        $('#dpd1').val(now.format("yyyy-MM-dd"));
        $('#dpd3').val(now.format("yyyy-MM-dd"));
