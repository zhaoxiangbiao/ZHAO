...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/ssp/logs/adCountSlotEveryDayCount/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_SSP_LOGS_ADCOUNTSLOTEVERYDAYCOUNT_" ></c:set>
<c:set scope="page" var="dataTitle" value="广告位每日明细" ></c:set>
<c:set scope="page" var="tableId" value="data_table_ssp_logs_adCountSlotEveryDayCount_1" ></c:set>
<%
...
//	         minDate: '',
 ...
 TableAjax.init('${tableId}',{
	 sAjaxSource: "${urlPrev }listJSON?slotid=${slotid}",
	 ...
	 aoColumns: [
			...
			{sTitle:'广告位名称',  mData: "slotname",uxLongText:true},				
			...
			{sTitle:'ECPM',  mData: "ecpm",uxLongText:true},	
