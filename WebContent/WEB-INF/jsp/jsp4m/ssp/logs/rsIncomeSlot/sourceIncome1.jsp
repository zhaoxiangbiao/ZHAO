...
<c:set scope="page" var="tableId" value="data_table_ssp_logs_sourceIncome_1" ></c:set>
						...
						<div class="widget-header ">
							...
							<form class="form-inline" role="form" onsubmit="return false;" id="form_${tableId}">
								<input type="hidden" id="startDateSS1" name="statDate" value="${statDate }" >
										...
										原始广告位名称: <input type="text"  style="height:26px;margin-top:-1px;" class="form-control  " name="sName"  placeholder="">
...
//		  	  return '<a class="blue-stripes" href="javascript:loadChartData('+data+',\''+all.${tt}_name+'\');" ">查看数据</a> ';	        
     ...
     var oTable = TableAjax.init('${tableId}',{
					 sAjaxSource: "${urlPrev }sourceIncomeJson1",
					 ...
					 aoColumns: [		
// 									{sTitle:'三方源',"sWidth": "140px",mData: "source_name" },
									{sTitle:'原始广告位',"sWidth": "140px",mData: "source_slot_name" },
									{sTitle:'展示(PV)',"sWidth": "140px",mData: "pv" ,uxNumber:true},
// 									{sTitle:'点击',"sWidth": "140px",mData: "cli" ,uxNumber:true},
...
// 									{sTitle:'点击',"sWidth": "140px",mData: "cli2" ,uxNumber:true},
									...
									{sTitle:'操作',mData:"id",sWidth:"100px",bSortable:false,mRender:oBtn}
				     ]
		});
      var isEditing = null;
...
//              	 id:aData['id'],
                	 ...
                	 cli:aData['cli'],
                	 target_type:1,
                	 target_id:aData['source_slot_id'],
                	 target_name:aData['source_slot_name'],
                	 stat_date:'${statDate }',
                	 income:income
              },
