...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/ssp/logs/adRequestStatDay/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_SSP_LOGS_ADREQUESTSTATDAY_" ></c:set>
<c:set scope="page" var="dataTitle" value="请求总次数统计表" ></c:set>
<c:set scope="page" var="tableId" value="data_table_ssp_logs_adRequestStatDay_1" ></c:set>
<div class="row">
				<div class="col-md-12">
...
$(document).ready(function() {
 ...
 TableAjax.init('${tableId}',{
	 ...
	 aoColumns: [
			...
			{sTitle:'当日请求次数',  mData: "request_today",uxLongText:true},				
			{sTitle:'历史累计请求总次数',  mData: "request_history",uxLongText:true},				
			{sTitle:'累计请求总次数',  mData: "request",uxLongText:true},		        
          {uxCogs:[
	          {name:"查看"}
