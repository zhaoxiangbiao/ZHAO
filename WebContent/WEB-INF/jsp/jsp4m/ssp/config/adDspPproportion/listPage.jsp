...
$(document).ready(function() {
 ...
 TableAjax.init('${tableId}',{
	 ...
	 uxDrapable:false,
	 aoColumns: [		
			{sTitle:'目标类型',  mData: "type",uxLongText:true},				
			{sTitle:'目标ID',  mData: "target_id",uxLongText:true},				
			{sTitle:'dsp 唯一标识',  mData: "dsp_id",uxLongText:true},				
			{sTitle:'展示量占比（%）',  mData: "proportion",uxLongText:true},		        
          {uxCogs:[
	          {name:"查看"}
