...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/everad/conf/uaBlacklist/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_EVERAD_CONF_UABLACKLIST_" ></c:set>
<c:set scope="page" var="dataTitle" value="UA黑名单" ></c:set>
<c:set scope="page" var="tableId" value="data_table_everad_conf_uaBlacklist_1" ></c:set>
<div class="row">
				<div class="col-md-12">
...
$(document).ready(function() {
 ...
 TableAjax.init('${tableId}',{
	 ...
	 uxDrapable:false,
	 aoColumns: [		
			{sTitle:'UA',  mData: "name",uxLongText:true},		        
          {uxCogs:[
	          {name:"查看"}
