...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/ssp/config/adSourceReferer/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_SSP_CONFIG_ADSOURCEREFERER_" ></c:set>
<c:set scope="page" var="dataTitle" value="来源认可网站" ></c:set>
<c:set scope="page" var="tableId" value="data_table_ssp_config_adSourceReferer_1" ></c:set>
<div class="row">
				<div class="col-md-12">
				...
				<span class="widget-caption">数据列表</span>
                  ...
                  <div class="widget-buttons buttons-bordered">
						...
						<form class="form-inline" role="form" onsubmit="return false;" id="form_${tableId}">
								...
								<label  class="col-sm-4 control-label no-padding-right">认可网站地址</label>
								<div class="col-sm-8">
									<input type="text" class="form-control  " name="filter_LIKES_referer"  placeholder="">
								</div>
								</div>
...
$(document).ready(function() {
 ...
 TableAjax.init('${tableId}',{
	 ...
	 uxDrapable:false,
	 aoColumns: [		
			{sTitle:'来源',  mData: "source_id",uxLongText:true},				
			{sTitle:'认可网站地址',  mData: "referer",uxLongText:true},				
			{sTitle:'优先级',  mData: "weight",uxLongText:true},				
			{sTitle:'来源认可网站状态', mData: "status" ,uxEnum:'t_ad_status',uxFastSet:true},		        
          {uxCogs:[
	          {name:"查看"}
