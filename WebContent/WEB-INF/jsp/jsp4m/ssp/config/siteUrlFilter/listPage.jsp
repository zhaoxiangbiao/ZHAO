...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/ssp/config/siteUrlFilter/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_SSP_CONFIG_SITEURLFILTER_" ></c:set>
<c:set scope="page" var="dataTitle" value="站点黑白名单" ></c:set>
<c:set scope="page" var="tableId" value="data_table_ssp_config_siteUrlFilter_1" ></c:set>
<div class="row">
				<div class="col-md-12">
...
$(document).ready(function() {
 ...
 TableAjax.init('${tableId}',{
	 ...
	 uxDrapable:false,
	 aoColumns: [		
			{sTitle:'站点所属媒体',  mData: "pub_id",uxLongText:true},				
			{sTitle:'站点',  mData: "site_id",uxLongText:true},				
			{sTitle:'名单类型(0：黑名单；1白名单)',  mData: "type",uxLongText:true},				
			{sTitle:'',  mData: "domain",uxLongText:true},		
