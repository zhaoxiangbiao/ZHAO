...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/everad/conf/template/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_EVERAD_CONF_TEMPLATE_" ></c:set>
<c:set scope="page" var="dataTitle" value="模板表" ></c:set>
<c:set scope="page" var="tableId" value="data_table_everad_conf_template_1" ></c:set>
<div class="row">
				<div class="col-md-12">
				...
				<span class="widget-caption">数据列表</span>
                  ...
                  <div class="widget-buttons buttons-bordered">
						...
						<form class="form-inline" role="form" onsubmit="return false;" id="form_${tableId}">
								...
								<label  class="col-sm-4 control-label no-padding-right">模板名称</label>
								<div class="col-sm-8">
								...
								<div class="col-sm-8">
									<tag:enum name="filter_EQS_size"  attrs="placeholder=''" cssClass="form-control  select2me"  enumName="ea_size" tagType="edit" />
								...
								<div class="form-group ">
								<label  class="col-sm-4 control-label no-padding-right">位置</label>
								<div class="col-sm-8">
									<tag:enum name="filter_EQS_location"  attrs="placeholder=''" cssClass="form-control  select2me"  enumName="ea_location" tagType="edit" />
...
$(document).ready(function() {
 ...
 TableAjax.init('${tableId}',{
	 ...
	 uxDrapable:false,
	 aoColumns: [		
			{sTitle:'模板名称',  mData: "name",uxLongText:true},		
			{sTitle:'尺寸',mData: "size" ,uxEnum:'ea_size'},
			{sTitle:'位置',mData: "location" ,uxEnum:'ea_location'},        
          {uxCogs:[
	          {name:"查看"}
