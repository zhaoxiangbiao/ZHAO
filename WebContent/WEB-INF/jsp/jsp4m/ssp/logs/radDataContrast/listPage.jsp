...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/ssp/logs/radDataContrast/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_SSP_LOGS_RADDATACONTRAST_" ></c:set>
<c:set scope="page" var="dataTitle" value="原始广告位数据汇总表" ></c:set>
<c:set scope="page" var="tableId" value="data_table_ssp_logs_radDataContrast_1" ></c:set>
<style>
...
<div class="row">
  <div class="col-md-12">
    <form id="${formId }_1" method="post" action="/ssp/logs/radDataContrast/save" class="bv-form" >
      <div class="form-body">
    ...
    <form id="${formId }_2" method="post" action="/ssp/logs/radDataContrast/save" class=" bv-form" >
      <div class="form-body">
        <div class="col-lg-12 col-sm-12 col-xs-12">
          <div class="well with-header clearfix">
