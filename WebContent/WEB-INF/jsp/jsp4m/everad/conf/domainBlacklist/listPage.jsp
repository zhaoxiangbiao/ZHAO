...
<!-- BEGIN PAGE CONTENT-->
<!-- BEGIN ROW CONTENT-->
<c:set scope="page" var="urlPrev" value="${ctx }/everad/conf/domainBlacklist/" ></c:set>
<c:set scope="page" var="rolePrev" value="ROLE_EVERAD_CONF_DOMAINBLACKLIST_" ></c:set>
<c:set scope="page" var="dataTitle" value="域名黑名单" ></c:set>
<c:set scope="page" var="tableId" value="data_table_everad_conf_domainBlacklist_1" ></c:set>
<div class="row">
				<div class="col-md-12">
...
$(document).ready(function() {
 ...
 TableAjax.init('${tableId}',{
	 ...
	 uxDrapable:false,
	 aoColumns: [		
			{sTitle:'域名',  mData: "name",uxLongText:true},		        
          {uxCogs:[
	          {name:"查看"}
